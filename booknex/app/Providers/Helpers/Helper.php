...
class Helper
{
	...
	public static function _post( $key , $default = null , $check_type = null , $whiteList = [] )
	{
		...
		if( $res !== $default && !is_null( $check_type ) )
		{
			...
			{
				$res = is_string( $res ) && filter_var(trim($res), FILTER_VALIDATE_EMAIL) !== false ? trim( (string)$res ) : $default;
			}
    ...
    public static function setTranslatedOption($translations, $options = [] ) {
