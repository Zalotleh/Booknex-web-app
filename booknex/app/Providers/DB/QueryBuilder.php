...
class QueryBuilder extends \stdClass
{
	...
	public function __call( $name, $arguments )
	{
		...
		elseif ( method_exists( $this->_properties_qb['model'], $name ) && is_callable( [ $this->_properties_qb['model'], $name ] ) )
		{
			return call_user_func_array( [ $this->_properties_qb['model'], $name ], $arguments );
		}
